...
const I18N = {
  ko: {
    ...
    mastSub:"26개국의 국기·수도·인구·면적·언어·종교·통화를 한눈에. 나라를 눌러 상세 페이지로 들어가고, 가봤어요·가고싶어요·댓글로 여행의 기억을 나눠요.",
  ...
  en: {
    ...
    mastSub:"Flags, capitals, population, area, languages, religion, and currency for 26 countries at a glance. Tap a country for its page, and share your travel memories with been-there, want-to-go, and comments.",
